...
cc.Class({
    ...
    loadLastSetting: function loadLastSetting() {
        ...
        this.lb_button_sound.string = eff_disable ? "On" : "Off";
...
cc.Class({
    ...
    runEffect: function runEffect(spAtlas, id) {
        ...
        for (var ix = 0; ix <= 8; ix++) {
            ...
            var delay = cc.delayTime(time1 + 0.2);
...
cc.Class({
    ...
    updateFrame: function updateFrame(obj_info) {
        ...
        lbscore.string = "" + this.count_updateRun;
